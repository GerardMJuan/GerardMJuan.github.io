...
`Aug 2025 - Present`
__Eden__ - Senior AI Researcher (Remote, México)
...
`Oct 2022 - Present`
__Universitat Pompeu Fabra - BCN Medtech__ - Research Scientist (Barcelona, Spain)
...
`Apr 2021 - Oct 2022`
__Vall d'Hebron Research Institute__ - Postdoctoral Researcher (Barcelona, Spain)
...
`Nov 2016 - Mar 2021`
__Universitat Pompeu Fabra - BCN Medtech__ - Ph.D. Researcher (Barcelona, Spain)
...
`Apr 2021`
__Universitat Pompeu Fabra__ - Ph.D. in Information and Communication Technologies (Barcelona, Spain)
...
`Oct 2016`
__Universitat Autònoma de Barcelona__ - MSc in Computer Vision (Barcelona, Spain)

`Sept 2015`
__Universitat Politècnica de Catalunya__ - Bachelor's degree in Informatics Engineering (Barcelona, Spain)

## Selected Publications

See my [Publications](/publications/) page for a complete list.

**Martí-Juan, G.**, Lorenzi, M., Sanroma-Guell, G., et al. (2023). MC-RVAE: Multi-channel recurrent variational autoencoder for multimodal Alzheimer's disease progression modelling. _NeuroImage_. [DOI](https://doi.org/10.1016/j.neuroimage.2023.119892)

**Martí-Juan, G.**, Sastre-Garriga, J., et al. (2023). Using The Virtual Brain to study the relationship between structural and functional connectivity in patients with multiple sclerosis: a multicenter study. _Cerebral Cortex_. [DOI](https://doi.org/10.1093/cercor/bhad041)

**Martí-Juan, G.**, Frias, M. et al. (2022). Detection of lesions in the optic nerve with magnetic resonance imaging using a 3D convolutional neural network. _NeuroImage: Clinical_. [DOI](https://doi.org/10.1016/j.nicl.2022.103187)

**Martí-Juan, G.**, Sanroma-Guell, G., Cacciaglia, R., et al. (2020). Nonlinear interaction between APOE ε4 allele load and age in the hippocampal surface of cognitively intact individuals. _Human Brain Mapping_. [DOI](https://doi.org/10.1002/hbm.25202)
